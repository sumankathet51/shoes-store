...
import navItems from '../../data/navbar/nav';
                        ...
                        <ul>
                            ...
                            </li>
                            {
                                navItems.map((value, index) => {
                                    return <li key={index}><Link to={value.url}> {value.name} </Link></li>
                                })
                            }
                            <li className={"cart"}>
                                <Link to={"/cart"}>
                                {
                                   cart && cart.length>0 && <span className={"cart-counter"} > {cart.length} </span>
                                }

                                <svg xmlns="http://www.w3.org/2000/svg" width="57.169" height="51" viewBox="0 0 57.169 51">
