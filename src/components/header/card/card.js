...
export const Card = ({products, currentImage, cart, setCart}) => {
    return(
        <div className={"main-image-card flex-center"}>
            <div className="card-contain">
                ...
                <div className="grid-container">
                    <div className="features-container">
                        <Link to={"/product/" + products.id} className="features">
                            <span> View </span> Product
                    ...
                    <div className="desc-container">
                        ...
                        <h3 className="price"> ${products.price - (products.discount / 100 * products.price)} </h3>
                        <p> <span className="price-old"> ${products.price} </span> <span className="discount"> {products.discount}% Off </span> </p>
                        <button className="btn btn-primary" onClick={() => {
                            if(cart && !cart.includes(products)) {
                                let currentArray = cart.slice();
                                currentArray.push(products);
